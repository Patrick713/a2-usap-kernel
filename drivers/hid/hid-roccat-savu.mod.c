...
__used __section(__versions) = {
	...
	{ 0x18d59eaf, "roccat_common2_sysfs_read" },
	{ 0xb6bc146a, "roccat_common2_sysfs_write" },
	{ 0x7fa795f, "_dev_err" },
	{ 0x5c66f448, "roccat_connect" },
	{ 0xabd19c4f, "roccat_common2_device_init_struct" },
...
MODULE_INFO(srcversion, "CE61D31F33237CA01368C50");
